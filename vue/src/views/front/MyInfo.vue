<template >
  ...
  <div style="width: 80%;margin: 30px auto">
    <div style="margin: 20px 0">
      <el-input placeholder="请输入资料名称" style="width: 200px" v-model="name" size="mini"></el-input>
      ...
      <el-button type="primary" plain @click="handleAdd" size="mini">发布资料</el-button>
      <el-button type="danger" plain @click="delBatch" size="mini">批量删除</el-button>
    </div>
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="课程名称" show-overflow-tooltip width="250"></el-table-column>
        <el-table-column prop="userName" label="上传用户"></el-table-column>
        <el-table-column prop="time" label="上传时间"></el-table-column>
        <el-table-column prop="recommend" label="是否推荐" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="课程信息" :visible.sync="fromVisible" width="55%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="score" label="所需积分">
          <el-input v-model="form.score" autocomplete="off" placeholder="请输入积分(0表示免费)"></el-input>
        </el-form-item>
